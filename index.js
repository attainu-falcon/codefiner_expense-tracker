...
//     db.collection('userRegister').find({$or: [{email: email}, {username: username}]}, function(err, registered) {
//         if(err) throw err;
//         else if(registered) {
...
//             res.render('signin',{
//                 title: 'Login',
                //    msg: 'Succefully registered. Now you may login.'
//             });
//         }
//     });
// });
